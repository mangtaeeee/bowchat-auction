...
import com.example.productservice.user.event.ProcessedUserEventRepository;
import com.example.productservice.user.event.UserCreatedEvent;
import com.example.productservice.user.event.UserEventConstants;
